...
namespace Idle
{
    ...
    public class AdmobConfig : ScriptableObject
    {
        ...
        [Header("Banner ID")]
        public string bannerViewID = "ca-app-pub-8496433923385400/8872143420";

        [Header("Interstitial ID")]
        public string interstitialID = "ca-app-pub-8496433923385400/9151345021";

        [Header("Reward ID")]
        public string rewardBasedVideoID = "ca-app-pub-8496433923385400/1154677140";
